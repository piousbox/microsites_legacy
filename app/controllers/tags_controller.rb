...
class TagsController < ApplicationController
  ...
  def show
    ...
    @reports = @tag.reports.all.fresh.public.page( params[:reports_page] )
    @galleries = @tag.galleries.all.fresh.public.page( params[:galleries_page] )
    @videos = @tag.videos.all.fresh.public
